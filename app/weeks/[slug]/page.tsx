  ...
  return (
    <div className="lg:w-[60%] sm:w-[95%] md:w-[75%] mx-auto">
      <Link
        ...
        href="/weeks"
      >
        <ArrowLeftIcon className="w-4 h-4 mr-1.5" /> Back to weeks
      </Link>
      ...
      {/* Optional: Keep frontmatter-based YouTube section for backward compatibility */}
      {/* {res.frontmatter.youtube && (
        <div className="mt-10">
          <YouTube
            videoId={res.frontmatter.youtube}
